...
export default function ServiceStatus({ services, onConnect, onRefresh }: ServiceStatusProps) {
          ...
          >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5 mt-1">
                    <div className={`w-2 h-2 rounded-full ${
                      ...
                      status === "expired" ? "bg-amber-400" : "bg-gray-500"
                    }`} />
                    <span className={`text-xs font-medium ${
                      isConnected ? "text-emerald-400" :
                      status === "expired" ? "text-amber-400" : "text-gray-400"
                    }`}>
            ...
            {isConnected ? (
              ...
              <button
                ...
                className="w-full py-2 px-3 rounded-lg bg-white/10 hover:bg-white/20 text-white text-sm font-medium transition-colors border border-white/10"
              >
                Connect
              </button>
            )}
